...
| 3 | **Sapling** (`sapling`) | Fire a seed that lands on the ground, raises an emerald temple statue with pink glow, and lures enemies nearby | projectile_line / ground_target | cd 8s, dur 18s | range 10 | lure |
