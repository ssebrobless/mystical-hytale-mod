...
public final class StyleTestMobActions {
    ...
    public String spawn(String playerId, Player runtimePlayer, String mode) {
        ...
        if ("cluster".equals(normalizedMode)) {
            addNpc(targets, world, basePosition.clone().addScaled(horizontalForward, 4.0), "Test_Dummy_Stationary");
            addNpc(targets, world, basePosition.clone().addScaled(horizontalForward, 4.0).addScaled(right, 3.0), "Test_Dummy_Stationary");
            addNpc(targets, world, basePosition.clone().addScaled(horizontalForward, 4.0).addScaled(right, -3.0), "Test_Dummy_Stationary");
            addNpc(targets, world, basePosition.clone().addScaled(horizontalForward, 7.0), "Test_Dummy_Stationary");
            addNpc(targets, world, basePosition.clone().addScaled(horizontalForward, 2.0), "Test_Dummy_Stationary");
        } else if ("line".equals(normalizedMode)) {
            addNpc(targets, world, basePosition.clone().addScaled(horizontalForward, 4.0), "Test_Dummy_Stationary");
            addNpc(targets, world, basePosition.clone().addScaled(horizontalForward, 8.0), "Test_Dummy_Stationary");
            addNpc(targets, world, basePosition.clone().addScaled(horizontalForward, 12.0), "Test_Dummy_Stationary");
        } else if ("surround".equals(normalizedMode)) {
            addNpc(targets, world, basePosition.clone().addScaled(horizontalForward, 3.0), "Test_Dummy_Stationary");
            addNpc(targets, world, basePosition.clone().addScaled(horizontalForward, -3.0), "Test_Dummy_Stationary");
            addNpc(targets, world, basePosition.clone().addScaled(right, 3.0), "Test_Dummy_Stationary");
            addNpc(targets, world, basePosition.clone().addScaled(right, -3.0), "Test_Dummy_Stationary");
        } else {
